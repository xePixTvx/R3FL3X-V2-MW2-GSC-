...
init()
{
	...
	{
		level.missileRemoteLaunchVert = 999999999;
		level.missileRemoteLaunchHorz = 999999999;
		level.missileRemoteLaunchTargetDist = 999999999;
	}
...
MissileEyes( player, rocket )
{
	...
	if ( isDefined( rocket ) )
	{
		...
		player setorigin( rocket.origin );
